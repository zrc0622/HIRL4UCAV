...
import time
from expert_data.serpentine.ai_env import *
import numpy as np
import csv
...
while episode <= 100:
    ...
    if episode_step > 2500 or fire-lock>500 or fire-lock<0:
        ...
        plot_trajectories(ally_pos, ennemy_pos, save_path=f"expert_data/serpentine/plot/{episode}.")
...
filename = 'expert_data/serpentine/expert_data_ai.csv'
